...
from model.EvolveGCN.script.GCNCONV import GCNConv
...
class EvolveGCN(nn.Module):
    def __init__(self, args):
        ...
        self.output_dim = args.out_feat
        self.egcn_type = args.egcn_type

        self.feat = Parameter((torch.ones(args.node_num, args.nfeat)).to(args.device), requires_grad=True)
    ...
    def forward(self, graphs):
        ...
        return torch.stack(nodes_list, dim=1)
